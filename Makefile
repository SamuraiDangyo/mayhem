...
release: clean
	x86_64-w64-mingw32-g++ $(CFLAGS) -static -DWINDOWS $(FILES) -o mayhem-0.50-x86-windows-modern-64bit.exe
	clang++ $(CFLAGS) -static $(FILES) -o mayhem-0.50-x86-unix-modern-64bit
