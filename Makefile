...
test:
	cutechess-cli -engine cmd=./$(EXE) dir=. proto=uci -engine cmd=fruit proto=uci -repeat -each tc=30+.1 -rounds 100 -resign movecount=8 score=500 -draw movenumber=40 movecount=10 score=30 -pgnout games.pgn
